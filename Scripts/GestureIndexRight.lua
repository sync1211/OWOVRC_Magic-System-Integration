...
local chargeFire = self.parent.children["ChargeFire"]

local sprayReady = self.parent.children["SprayReady"]
local sprayActive = self.parent.children["SprayActive"]

local weaponReady = self.parent.children["WeaponReady"]
local weaponActive = self.parent.children["WeaponActive"]
local weaponFire = self.parent.children["WeaponFire"]

local auraReady = self.parent.children["AuraReady"]
local auraActive = self.parent.children["AuraActive"]

local castReady = self.parent.children["CastReady"]
local castCharging = self.parent.children["CastCharging"]
local castFire = self.parent.children["CastFire"]
